...
const Taekwondo = () => (
 ...
 <p>C 1 сентября вступили в силу изменения правил соревнований по тхэквондо. C полным текстом новых правил, а также со списком изменений можно ознакомиться в разделе <Link className='link' href='/02-docs/04'>документы</Link>. </p>
  </>
)
